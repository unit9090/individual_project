...
public class TrainerPtDiaryUpdateFrame extends JFrame {
	 ...
	 */
	public static void showPtDiaryUpdate(Component parent) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					TrainerPtDiaryUpdateFrame frame = new TrainerPtDiaryUpdateFrame(parent);
	...
	public TrainerPtDiaryUpdateFrame(Component parent) {
		this.parent = parent;
		initialize();
	}
